    ...
    <div className="tw-max-w-7xl tw-mx-auto tw-p-6 tw-min-h-screen">
      <div className="tw-flex tw-justify-between tw-items-center tw-mb-6">
        ...
        <Button
          variant="contained"
          color="primary"
          className="tw-bg-purple-500 tw-text-white tw-py-2 tw-px-4"
        >
          Bảng điều khiển
        </Button>
      </div>
      ...
      <div
        ...
        className=" tw-py-4 tw-px-6 tw-flex tw-justify-between tw-items-center tw-mb-6 tw-shadow-md"
      >
        <p>
      ...
      <div className="tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-4">
        {posts
          ...
          .map((post) => (
            <div
              key={post.id}
              className="tw-bg-white tw-p-4 tw-shadow-md tw-border tw-flex"
            >
              <div className="tw-flex-grow">
                <h2 className="tw-font-semibold tw-text-base tw-mb-1">
                  {post.title}
                </h2>
                <p className="tw-text-gray-600  tw-text-xs tw-w-[80%] tw-mb-2">
                  {post.description}
                </p>
                ...
                <div className="tw-flex tw-justify-between">
                  <div className="tw-grid tw-grid-flow-row tw-row-span-2 tw-items-center tw-w-[50%] tw-pr-4">
                    {post.author === 'Admin' ? (
                      <Button
                        variant="contained"
                        color="primary"
                        className="tw-bg-purple-500 tw-my-4 hover:tw-bg-purple-600 tw-w-full tw-text-white tw-mb-2"
                      >
                        Xem bài viết
                      </Button>
                    ) : (
                      <>
                        ...
                        <Button
                          variant="contained"
                          color="error"
                          className="tw-bg-red-500 tw-my-4 hover:tw-bg-red-600 tw-text-white"
                  ...
                  <div className="tw-mt-4 tw-text-sm tw-flex tw-w-[30%] tw-flex-col tw-text-gray-600">
                    <p>
                      <span className="tw-font-bold tw-py-2">Lượt xem:</span>{' '}
                      {post.views}
                    </p>
                    <p>
                      <span className="tw-font-bold tw-py-2">Danh mục:</span>{' '}
                      {post.category}
                    </p>
                    <p>
                      <span className="tw-font-bold tw-py-2">Ngày tạo:</span>{' '}
                      {post.date}
                    </p>
                  </div>
                </div>
      ...
      <div className="tw-flex tw-justify-between tw-mt-6">
        <Button
          variant="contained"
          className="tw-via-violet-500 tw-text-white tw-py-2 tw-px-4"
        ...
        <Button
          variant="contained"
          className="tw-via-violet-500 tw-text-white tw-py-2 tw-px-4 tw-ml-4"
        ...
        <div className="tw-fixed tw-inset-0 tw-bg-black tw-bg-opacity-50 tw-flex tw-justify-center tw-items-center">
          <div className="tw-bg-white tw-p-4 tw-rounded tw-shadow-lg">
            ...
            <div className="tw-flex tw-justify-end tw-mt-4">
              <Button
                onClick={handleClose}
                className="tw-text-gray-500 tw-mr-4"
              >
                Hủy
              </Button>
              <Button
        ...
        <div className="tw-fixed tw-inset-0 tw-bg-black tw-bg-opacity-50 tw-flex tw-justify-center tw-items-center">
          <div className="tw-bg-white tw-p-4 tw-rounded tw-shadow-lg">
            ...
            <div className="tw-flex tw-justify-end tw-mt-4">
              ...
              <Button
                variant="contained"
                className="tw-bg-red-500 tw-text-white tw-py-2 tw-px-4"
