...
const Header: React.FC = () => {
    ...
    return (
        <header className={`tw-bg-[${theme.palette.background.paper}] tw-mt-0 md:tw-mt-2 tw-rounded-md md:tw-text-left`}>
            <div className={clsx(s['header'], 'container tw-mx-auto tw-py-10 md:tw-py-40 md:tw-bg-hero tw-bg-contain tw-bg-no-repeat tw-bg-[right_0px_top_10px]')}>
                ...
                <form action="" method="get" className="tw-mt-4">
                    <div className="tw-flex tw-bg-white tw-items-center tw-p-4">
                        <div className="tw-basis-1/3 md:tw-basis-3/6 tw-relative">
                            <span className="tw-absolute tw-top-0.5 tw-left-4">
                            </span>
                            <input
                                type="search"
                        ...
                        <div className="tw-basis-1/3 md:tw-basis-2/6 tw-flex">
                            ...
                            <div className="tw-flex-1">
                                <select name="category" id="category_id" className="tw-bg-white tw-text-gray-400 tw-font-thin tw-w-full">
                        ...
                        <div className="tw-basis-1/3 md:tw-basis-1/6">
                            <button
                                className="tw-transition tw-bg-red-500 tw-text-white tw-px-8 hover:tw-opacity-75 tw-rounded-full tw-p-3 tw-w-full tw-ml-3">
                                Search
                            </button>
                        </div>
                    </div>
