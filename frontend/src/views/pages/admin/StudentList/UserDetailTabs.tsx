...
const UserDetails = () => {
  ...
  const userInfoContent = user ? <UserInfo user={user} /> : <Typography color="error">Không tìm thấy thông tin người dùng</Typography>;
  const coursesInfoContent = courses.length > 0 ? <CoursesInfo courses={courses} /> : <Typography>Tài khoản này chưa đăng ký khóa học nào.</Typography>;

  return (
    <Box sx={{ padding: "20px" }}>
      <HeaderTitle des="Đây là trang chi tiết người dùng" link="/student-list" titleButton="Quay lại" />
