...
import { BiCategoryAlt, BiAdjust, BiBell, BiChalkboard, BiListUl, BiCloset, BiX, BiLogIn, BiSolidRegistered, BiUserPlus } from 'react-icons/bi';
            ...
            <div className={clsx(s['content-nav'], "container tw-mx-auto")}>
                <div className="tw-flex tw-justify-between">
                    <div className="tw-flex tw-justify-center tw-items-center">
                        ...
                        <div style={{ width: '400px' }} className="tw-hidden md:tw-block tw-ml-16 tw-relative">
                    ...
                    <div className="tw-flex tw-justify-center tw-items-center tw-pr-4 md:tw-pr-0">
                        <ul className="tw-list-none tw-mr-10">
                        ...
                        {/* user info */}
                        <div className="tw-hidden md:tw-block tw-group">
                            <Link
                                to="#"
                            ...
                            >
                                <HeadlessTippy
                                    ...
                                    interactive
                                    render={attrs => (
                                        <Wrapper style={{ background: theme.palette.background.paper }} {...attrs} >
                                            <Link className="tw-flex tw-bg-indigo-500 tw-text-white tw-font-bold tw-py-2 tw-px-4 tw-rounded tw-border-indigo-700 hover:tw-bg-indigo-600 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-indigo-400 focus:tw-ring-opacity-50 transition" to={path.client.auth.login}>  <BiLogIn /> Login</Link>
                                            <Link className="tw-mt-2 tw-flex tw-bg-blue-500 tw-text-white tw-font-bold tw-py-2 tw-px-4 tw-rounded hover:tw-bg-blue-600 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-blue-400 focus:tw-ring-opacity-50 transition" to={path.client.auth.register}><BiUserPlus />Register</Link>
                                        </Wrapper>
                                    )}
                                >
                ...
                <div onClick={handleToggleNavMobile} className="tw-absolute tw-top-1 tw-right-3 tw-cursor-pointer tw-mt-5">
                    <span style={{ color: theme.palette.text.primary }} className="md:tw-hidden navbar-toggle tw-text-slate-900">
